        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about/mission" className="text-blue-200/70 hover:text-blue-400 text-sm transition-colors">
                  Mission & Values
                </Link>
              </li>
              <li>
                <Link href="/about/business" className="text-blue-200/70 hover:text-blue-400 text-sm transition-colors">
                  Business Model
                </Link>
              </li>
              <li>
                <Link href="/about/people" className="text-blue-200/70 hover:text-blue-400 text-sm transition-colors">
                  People & Culture
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/careers" className="text-blue-200/70 hover:text-blue-400 text-sm transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/products" className="text-blue-200/70 hover:text-blue-400 text-sm transition-colors">
                  Products Overview
                </Link>
              </li>
              <li>
                <Link
                  href="/products#bhramavora"
                  className="text-blue-200/70 hover:text-blue-400 text-sm transition-colors"
                >
                  Bhramavora OS
                </Link>
